...
from data.vqarad_dataset import VQA_dataset,Slake_dataset,VQA_Tuning_dataset, VQA_slake_test_dataset, VQA_Instruction_dataset
...
def main(args, config):
    ...
    result_file = save_result(vqa_result, args.result_dir, 'vqa_test_epoch129_result')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='/Dataset1/cjw/pretrained/VQA_FineTuning/Instruction_Tuning')
