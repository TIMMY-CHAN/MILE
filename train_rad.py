...
def main(args, config):
    ...
    datadir = r'/Dataset1/cjw/VQA_RAD/VQA_RAD_Image_Folder'
    train_labeldir = r'/Dataset1/cjw/VQA_RAD/train.jsol'
    test_labeldir = r'/Dataset1/cjw/VQA_RAD/test.jsol'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/home/cjw/code/VQA/miss-main/configs/vqa.yaml') 
    parser.add_argument('--output_dir', default='/Dataset1/cjw/pretrained/eval_result_3.8')
